...
%  Auto-generated by MATLAB on 28-Jun-2019 17:45:26
...
axes1 = axes('Parent',figure1,...
    'Position',[0.303806734992682 0.783167155425219 0.15 0.1464]);
plot([1 5 10],squeeze(rmse(1,1,1,:,1)),'.-')
% Create ylabel
...
axes2 = axes('Parent',figure1,...
    'Position',[0.555013792518098 0.783125610174911 0.150000000000005 0.146419844370543]);
plot([1 5 10],squeeze(rmse(1,1,1,:,1)),'.-')
% Create ylabel
ylabel('log(\lambda)','FontSize',14);
...
axes3 = axes('Parent',figure1,...
    'Position',[0.794083221932229 0.783125610174911 0.15 0.146419844370543]);
...
axes4 = axes('Parent',figure1,...
    'Position',[0.302767203513912 0.552841515219805 0.150000000000001 0.1464]);
...
axes5 = axes('Parent',figure1,...
    'Position',[0.555013792518098 0.550568787947079 0.150000000000005 0.146419844370543]);
...
axes6 = axes('Parent',figure1,...
    'Position',[0.794083221932229 0.550568787947079 0.15 0.146419844370543]);
...
axes7 = axes('Parent',figure1,...
    'Position',[0.302767203513912 0.303984271559102 0.150000000000001 0.1464]);
...
axes8 = axes('Parent',figure1,...
    'Position',[0.555013792518098 0.306256998831829 0.150000000000005 0.146419844370543]);
...
axes9 = axes('Parent',figure1,...
    'Position',[0.794083221932229 0.306256998831829 0.15 0.146419844370543]);
...
axes10 = axes('Parent',figure1,...
    'Position',[0.302767203513912 0.0603798876214555 0.150000000000001 0.1464]);
...
axes11 = axes('Parent',figure1,...
    'Position',[0.555013792518098 0.0626526148941828 0.150000000000005 0.146419844370543]);
...
axes12 = axes('Parent',figure1,...
    'Position',[0.794083221932229 0.0626526148941828 0.15 0.146419844370543]);
...
% Create line
annotation(figure1,'line',[0.0724743777452416 1.05563689604685],...
    [0.943700460829493 0.943700460829493]);

% Create line
annotation(figure1,'line',[0.0761346998535871 1.0592972181552],...
    [0.470973188102218 0.470973188102218],'LineWidth',1.5);

% Create line
annotation(figure1,'line',[0.0732064421669107 1.05636896046852],...
