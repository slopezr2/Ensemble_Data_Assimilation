...
for i=[1,3]
    ...
    title(['Analysis State for ' variables(i)],'FontAngle','italic','FontSize',12,'FontName','Arial','FontWeight','Normal')
...
%     figure
 subplot(2,4,[5 6])
    ...
    colormap(fig,'jet');
    set(gca,'LooseInset',get(gca,'TightInset')); 
    title(['Background State for ' variables(i)],'FontAngle','italic','FontSize',12,'FontName','Arial','FontWeight','Normal')
caxis([x1lim(i) x2lim(i)])
    %===real===
    aux=xmr_time(i);
    aux=aux{1};
...
%     figure
 subplot(2,4,[2 3])
    ...
    colormap(fig,'jet');
    set(gca,'LooseInset',get(gca,'TightInset')); 
    title(['True State ' variables(i)],'FontAngle','italic','FontSize',12,'FontName','Arial','FontWeight','Normal')
    caxis([x1lim(i) x2lim(i)])
end
%     %===XA===
