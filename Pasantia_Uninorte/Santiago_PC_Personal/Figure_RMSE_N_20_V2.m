...
plot([1 5 10],squeeze(rmse(1,1,1,:,1)),'o--','LineWidth',2,'MarkerSize',5,'MarkerFaceColor','b')
% Create ylabel
...
% Create ylabel
plot([1 5 10],squeeze(rmse(1,1,1,:,3)),'o--','LineWidth',2,'MarkerSize',5,'MarkerFaceColor','b')
...
plot([1 5 10],squeeze(rmse(1,1,1,:,5)),'o--','LineWidth',2,'MarkerSize',5,'MarkerFaceColor','b')
...
plot([1 5 10],squeeze(rmse(1,2,1,:,1)),'o--','LineWidth',2,'MarkerSize',5,'MarkerFaceColor','b')
% Create ylabel
ylabel('log(\lambda)','FontSize',14);
...
% plot([1 5 10],[-0.88 -0.89 -0.95],'o--','LineWidth',2,'MarkerSize',5,'MarkerFaceColor','b')
plot([1 5 10],squeeze(rmse(1,2,1,:,3)),'o--','LineWidth',2,'MarkerSize',5,'MarkerFaceColor','b')
% Create ylabel
ylabel('log(\lambda)','FontSize',14);
...
% plot([1 5 10],[0.22 0.29 0.32],'o--','LineWidth',2,'MarkerSize',5,'MarkerFaceColor','b')
plot([1 5 10],squeeze(rmse(1,2,1,:,5)),'o--','LineWidth',2,'MarkerSize',5,'MarkerFaceColor','b')
% Create ylabel
ylabel('log(\lambda)','FontSize',14);
...
plot([1 5 10],[-0.8 -0.75 -0.73],'o--','LineWidth',2,'MarkerSize',5,'MarkerFaceColor','b')
% Create ylabel
ylabel('log(\lambda)','FontSize',14);
...
plot([1 5 10],squeeze(rmse(2,1,1,:,3)),'o--','LineWidth',2,'MarkerSize',5,'MarkerFaceColor','b')
% Create ylabel
ylabel('log(\lambda)','FontSize',14);
...
plot([1 5 10],squeeze(rmse(2,1,1,:,5)),'o--','LineWidth',2,'MarkerSize',5,'MarkerFaceColor','b')
% Create ylabel
ylabel('log(\lambda)','FontSize',14);
...
plot([1 5 10],squeeze(rmse(2,2,1,:,1)),'o--','LineWidth',2,'MarkerSize',5,'MarkerFaceColor','b')
% Create ylabel
ylabel('log(\lambda)','FontSize',14);
...
plot([1 5 10],squeeze(rmse(2,2,1,:,3)),'o--','LineWidth',2,'MarkerSize',5,'MarkerFaceColor','b')
% Create ylabel
ylabel('log(\lambda)','FontSize',14);
...
plot([1 5 10],squeeze(rmse(2,2,1,:,5)),'o--','LineWidth',2,'MarkerSize',5,'MarkerFaceColor','b')
% Create ylabel
ylabel('log(\lambda)','FontSize',14);
